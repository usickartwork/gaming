  ...
  return (
    <div className="glass-panel rounded-3xl p-5 border border-white/10 space-y-4 shadow-xl">
        ...
        <div className="flex items-center gap-2">
          {onOpenSpotifySearch && (
            <button
              ...
              className="px-4 py-2 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-slate-950 font-black text-xs flex items-center gap-2 transition-all active:scale-95 shadow-md shadow-emerald-500/25"
            >
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Cari lagu di Spotify atau daftar... (Tekan Enter untuk cari di Spotify)"
          value={search}
      ...
      <div className="space-y-2 max-h-60 overflow-y-auto pr-1">
              ...
              <div className="min-w-0 flex items-center gap-3">
                ...
                <div className="truncate">
                  <div className="flex items-center gap-1.5">
                    ...
                    {isSpotify && (
                      <span className="text-[9px] font-black uppercase text-emerald-400 bg-emerald-500/20 px-1.5 py-0.2 rounded border border-emerald-500/30 shrink-0">
                        Spotify
                      </span>
                    )}
                  </div>
        ...
        {filtered.length === 0 && (
          <div className="text-center py-6 px-4 space-y-3 bg-slate-900/50 rounded-2xl border border-white/5">
            <p className="text-slate-400 text-xs">
              {search.trim()
                ? `Lagu "${search}" belum ada di daftar sesi.`
            ...
            {onOpenSpotifySearch && (
              ...
              >
                ...
                <span>Cari &quot;{search.trim() || 'Lagu Baru'}&quot; di Spotify</span>
              </button>
            )}
          </div>
        )}
