...
export default function PlayError({
  ...
  useEffect(() => {
    console.error('Play page runtime error:', error)
  }, [error])
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-slate-950 select-none">
      <div className="glass-panel rounded-3xl p-8 border border-white/10 text-center max-w-sm w-full space-y-5 shadow-2xl">
        ...
        <div>
          <h2 className="text-white text-lg font-black">Terjadi Kendala Memuat Game</h2>
          <p className="text-slate-400 text-xs mt-1.5 leading-relaxed">
            Halaman controller player mengalami kendala. Silakan coba muat ulang atau masuk kembali ke room.
          </p>
        </div>
